...
docs:
  ...
  functions:
    ...
    - name: SetPrompt
      desc: Sets the prompt that appears when executing commands. This is useful for a quick way to tell what game you're playing in a universe game, and what your current working instance is.
      params:
        - name: labelText
          type: string
    - name: SetEnabled
