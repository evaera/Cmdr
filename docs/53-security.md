...
There's a separate page [about security vulnerabilities in Cmdr itself](/docs/securityreport). Make sure you keep Cmdr up to date, we don't usually fix bugs in old versions of Cmdr.
